...
<main class="form-signin w-100 m-auto">
    <form action="{{ route("login.post") }}" method="POST">
        @csrf
        <img src="{{ asset("assets/img/logo.png") }}" class="mb-4" width="80" height="58" alt="logo">
        <h1 class="h3 wb-3 fw-normal">Please sign in</h1>
        ...
        <div class="form-check text-start my-3">
            <input type="checkbox" name="remeberme" class="form-check-input" value="remember-me" id="flexCheckDefault">
